<template>
  <Frame>
    <Page>
      <ActionBar title="Leaderboard Ranking" @test="test"/>
      <StackLayout>
        ...
        <Label textWrap="true"
          :text="this.showLeaderboard(players)"
...
const timerModule = require("tns-core-modules/timer");
  ...
  export default {
    ...
    data() {
      return {
        result: [],
        players: [{name: "ken",score: 1},{name: "mak",score: 0},{name: "D",score: 4},{name: "wil",score: 2}],
      }
    },
  }
</script>
