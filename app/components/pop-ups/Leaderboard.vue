<template>
  <Frame>
    <Page id="homeBackground">
      ...
      <StackLayout v-else>
          <Image src="https://www.rawshorts.com/freeicons/wp-content/uploads/2017/01/orange_prodpicttrophy_1484336291.png" height="50%"/>
          <Label  :text="`First Place - ${this.results[0]} score: ${this.scores[0]}`" class="h2 description-label" color="#58B0E5" backgroundColor="white" borderColor="#58B0E5"  borderWidth="1" borderRadius="5" />
          <Label  :text="`Second Place - ${this.results[1]} score: ${this.scores[1]}`" class="h2 description-label" color="#58B0E5" backgroundColor="white" borderColor="#58B0E5"  borderWidth="1" borderRadius="5" />
          <Button text="Create Game" width="60%" height="15%"
                    backgroundColor="#ff9933" marginTop="25" textAlignment="center"
                    color="white" fontSize="22" fontWeight="bold"
                    borderRadius="20" @tap="$modal.close()" />
