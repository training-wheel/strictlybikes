<template>
  <Frame>
    <Page>
      <ActionBar title="Leaderboard Ranking"/>
      <StackLayout v-if="`${this.gameMode} !== teamsprint`">
          ...
          <Label v-if="players[0]" :text="`First Place - ${this.results[0]}`" class="h2 description-label" color="#eb8100" backgroundColor="white" borderColor="#eb8100"  borderWidth="1" borderRadius="5" />
          ...
          <Label v-if="players[3]" :text="`First Place - ${this.results[3]}`" class="h2 description-label" color="#58B0E5" backgroundColor="white" borderColor="#58B0E5"  borderWidth="1" borderRadius="5" />
          <Label v-if="players[3]" :text="`Second Place - ${this.results[3]}`" class="h2 description-label" color="#58B0E5" backgroundColor="white" borderColor="#58B0E5"  borderWidth="1" borderRadius="5" />
      </StackLayout>
      <StackLayout v-else>
          <Image src="data:image/png;base64," height="50%"/>
