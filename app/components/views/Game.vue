  ...
  <Page class="page" id="homeBackground">
    ...
    <StackLayout>
      ...
      <Label :text="'My Markers : ' + securedMarkers + '/' + totalMarkers +'  '" class="action-label" color="white" marginLeft="10" fontWeight="bold"></Label>
          ...
          <Label v-if="players[2]" :text="`Third Place - ${this.results[2].name}  | score: ${this.results[2].score}`" class="h2 description-label" color="#58B0E5" backgroundColor="white" borderColor="#58B0E5"  borderWidth="1" borderRadius="5" />
          <Label v-if="players[3]" :text="`Fourth Place - ${this.results[3].name}  | score: ${this.results[3].score}`" class="h2 description-label" color="#58B0E5" backgroundColor="white" borderColor="#58B0E5"  borderWidth="1" borderRadius="5" />
    </StackLayout>
    </ScrollView>
    </StackLayout>
  </Page>
