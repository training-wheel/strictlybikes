  ...
  <Page class="page" id="homeBackground">
    ...
    <StackLayout>
      ...
      <Label :text="'My Markers : ' + securedMarkers + '/' + totalMarkers +'  '" class="action-label" color="white" marginLeft="10" fontWeight="bold"></Label>
          ...
          <Label v-if="players[1]" :text="`Second Place - ${this.results[1].name} | score: ${this.results[1].score}`" marginLeft="10" class="h2 description-label" color="#58B0E5" backgroundColor="white" borderColor="#58B0E5"  borderWidth="1" borderRadius="5" />
